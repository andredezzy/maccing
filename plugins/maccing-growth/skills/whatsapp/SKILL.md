...
|---|---|---|---|---|---|---|
| **Proxy Roque** (proxy-agenciaroque.com.br) | Datacenter IPv4, Residential ISP, Mobile 4G/5G | Yes | Yes — dedicated/exclusive per client on all non-scraping plans | BR-only (Vivo, Claro, TIM, Oi) | R$24,90/mo (Ultra BR Meta/Google); R$38/mo (IPv4 Dedicado); R$59/mo (Residencial) | Strong. Meta/Google-tuned line, 95%+ IPQualityScore, 1 IP per BM recommended. Flag: 47-day avg Reclame Aqui response time. IPv4 only for warming. |
...
| **Coronium.io** | Mobile 4G/5G (dedicated modem) | Yes | Partial — dedicated port, sticky ≤24h, on-demand rotation | São Paulo: Vivo 38%, Claro 33%, TIM 23% | $89/mo (30-day BR); $39/wk; $12/day | Very high. Dedicated Meta-BM + WhatsApp-warming page, 7–14 day protocol. AdsPower/GoLogin/Multilogin/Dolphin partner. Keep sticky ON during warming. |
