...
test("mapBlock maps every raw Notion block type to its MockupBlock type", () => {
  ...
  const raw: RawBlock[] = [
    ...
    { type: "video", video: { type: "external", external: { url: "https://x/v.mp4" } } },
    { type: "audio", audio: { type: "external", external: { url: "https://x/a.mp3" } } },
    { type: "file", file: { type: "external", external: { url: "https://x/f.pdf" } } },
    { type: "pdf", pdf: { type: "external", external: { url: "https://x/p.pdf" } } },
