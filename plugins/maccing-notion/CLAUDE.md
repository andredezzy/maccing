...
Instructions for any agent editing this plugin — the `notion-api` skill (`SKILL.md` + `references/`) and the bundled MCP server. Applies to the whole `plugins/maccing-notion/` subtree. (`AGENTS.md` here is a symlink to this file.)
