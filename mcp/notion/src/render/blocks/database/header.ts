...
// Two lines:
//   ◷ **Title**
//   Views: **Selected**, Other, Other, +N more
...
// the whole point, since that is the only place bold renders.
...
export function databaseHeader(
  ...
  // Reserve room for the "Views: " prefix, plus a ", +N more" count whenever tabs remain unshown — so the
  // line never overflows even after the count is appended.
  const budget = width - displayWidth(PREFIX);
