...
- [Chip Warming (Unofficial API Route) → see `disposable-bm-strategy.md`](../../meta/references/disposable-bm-strategy.md#chip-warming-unofficial-api-route)
...
- [Number Longevity & Cold Lists → see `disposable-bm-strategy.md`](../../meta/references/disposable-bm-strategy.md#number-longevity--cold-lists-preserve-over-burn)
...
> Moved to canonical location — see [`disposable-bm-strategy.md` → Chip Warming (Unofficial API Route)](../../meta/references/disposable-bm-strategy.md#chip-warming-unofficial-api-route).
...
> Moved to canonical location — see [`disposable-bm-strategy.md` → Number Longevity & Cold Lists (preserve over burn)](../../meta/references/disposable-bm-strategy.md#number-longevity--cold-lists-preserve-over-burn).
