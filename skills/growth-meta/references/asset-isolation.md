...
**Automating a BM's own profile:** see `skills/growth-meta/references/browser-automation.md`.
...
See `skills/growth-meta/references/disposable-bm-strategy.md` § BM Types (Market Reference).
